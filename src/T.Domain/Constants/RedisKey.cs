namespace T.Domain.Constants {
    public static class RedisKey {
        ...
        public static string GetSessionKey(string env, Guid merchantId, Guid userId) {
            return $"{env}:{merchantId}:Session:{userId}";
        }

        public static string GetSessionActionKey(string env, Guid merchantId, Guid userId) {
